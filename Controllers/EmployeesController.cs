...
namespace EZ_Task.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public EmployeesController(EZ_TaskContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Fullname,Email,Gender,Birthdate")] Employee employee)
        {
            if (id != employee.Id)
            {
                return NotFound();
